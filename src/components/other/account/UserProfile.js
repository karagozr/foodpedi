...
import ListeGrid from "../../places/ListeGrid";
...
function UserProfile () {
    ...
    return (
        <main className="user-profile">
            ...
            {/* Breadcrumb */}
            {/* <Breadcrumb CurrentPgTitle="" MenuPgTitle="Pages" img={states.BreadcrumbImg} /> */}
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-8">
                            <h3 className="widget-title"> {user.name}'in Ürünleri </h3>
                            <div className="title-shape"></div>
                            <div className="row two-clmn margin-top-35px">
                                {/* <PlaceGrid griditems={sectiondata.placesgrid} /> */}
                                <ListeGrid griditems={sectiondata.placesgrid} />
                            </div>
