                            ...
                            <div className="col-lg-6">
                                <div className="input-box">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input className="form-control" type="text" name="name" disabled="disabled" placeholder="Enes Özdemir" />
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-6">
                                <div className="input-box">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input className="form-control" type="email" name="email" disabled="disabled" placeholder="enes@ozdemir.com" />
                                    </div>
                                </div>
                            </div>
