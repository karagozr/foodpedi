...
import MaddeEtiket from "./MaddeEtiket";
import MaddePaylas from "./MaddePaylas";
        ...
        <>
            <div className="card-item blog-card border-bottom-0">
                <div className="card-image">
                    <img src={sectiondata.maddeDetails.img} alt="Blog" className="card__img"/>
                </div>
                <div className="card-content pl-0 pr-0 pb-0">
                    ...
                    <h2 className="card-title font-size-26">
                        {sectiondata.maddeDetails.title}
                    </h2>
                    <p className="card-sub mt-3">
                        {sectiondata.maddeDetails.desc1}
                    </p>
                    {/* <p className="card-sub mt-3">
                        {sectiondata.maddeDetails.desc2}
                    </p> */}
                    ...
                    <div className="tag-items d-flex justify-content-between">
                        ...
                        <MaddeEtiket taglists={sectiondata.maddeDetails.bltags.lists} title={sectiondata.maddeDetails.bltags.title} />
